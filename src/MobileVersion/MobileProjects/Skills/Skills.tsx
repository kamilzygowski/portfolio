...
const Skills = (props: any) => {
    const skills = [
        ...
        {id:2, name:'TypeScript', level: 70, background:'#70a1ff', icon:'https://i.postimg.cc/dDPnztQf/icons8-typescript-480.png'},
            ...
            <ul className='skillsContainer'>
                {skills.map((element:any, index:number) => {
                    ...
                    <li className='skillsLi' key={index}>
                        ...
                        <div className='bar' style={{color: element.background, width:`60%`}}>{element.name}</div>
                    </li>
                    )
                })}
            </ul>
